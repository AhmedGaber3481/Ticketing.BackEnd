...
{
    public class TicketCategoryLookupService : LookupService<LookupDTO>
    {
        private readonly IRepository<TicketCategory> _repository;
        public TicketCategoryLookupService(IRepository<TicketCategory> repository, IMemoryCache memoryCache) : base(memoryCache)
        {
