...
{
    public class TicketTypeLookupService : LookupService<LookupDTO>
    {
        private readonly IRepository<TicketType> _repository;
        public TicketTypeLookupService(IRepository<TicketType> repository, IMemoryCache memoryCache) : base(memoryCache)
        {
